...
public class Librarian {
	...
	public void takeDataLibraian() {
		try {
	        BufferedReader br = new BufferedReader(new FileReader("D:\\Java_LTHDT\\LibraryManagement\\src\\alldata\\DataLibrarian.txt"));
	        String line;
	...
	public void addReader(int id, String userName, String passWork, String nameReader, int ageReader, String address, long phoneReader, long cmnd) {
	    ...
	    try {
	        BufferedWriter writer = new BufferedWriter(new FileWriter("D:\\Java_LTHDT\\LibraryManagement\\src\\alldata\\DataReader.txt", true));
	...
	public void deleteReader(int keyDeleteReader, String nameUser,View view) {
	    ...
	    try {
	        PrintWriter printWriter = new PrintWriter(new FileWriter("D:\\Java_LTHDT\\LibraryManagement\\src\\alldata\\DataReader.txt", false));
	        for (Reader reader : Main.dataReader) {
