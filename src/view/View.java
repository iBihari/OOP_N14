...
public class View{
	...
	private JTextField jTextFieldBookCodeInLibrarianFoundSuccess;
	private JTextField jTextFieldCodeReaderUpdateReaderInLibrarian;
	private JTextField jTextFieldCodeReaderUpdateReaderInLibraian;
	private JTextField jTextFieldPassworkReaderUpdateReaderInLibraian;
	private JTextField jTextFieldUserNameReaderUpdateReaderInLibraian;
	private JTextField jTextFieldNameReaderUpdateReaderInLibraian;
	private JTextField jTextFieldAgeReaderUpdateReaderInLibraian;
	private JTextField jTextFieldAddresssReaderUpdateReaderInLibraian;
	private JTextField jTextFieldPhoneNumberReaderUpdateReaderInLibraian;
	private JTextField jTextFieldCMNDReaderUpdateReaderInLibraian;
	private JTextField jTextFieldCodeBookNeedUpdateInLibrarian;
	private JButton jButton_BorrowReader;

	

	public int getjTextFieldCodeReaderUpdateReaderInLibraian() {
		return Integer.parseInt(jTextFieldCodeReaderUpdateReaderInLibraian.getText());
	}

	public String getjTextFieldPassworkReaderUpdateReaderInLibraian() {
		return jTextFieldPassworkReaderUpdateReaderInLibraian.getText();
	}

	public String getjTextFieldUserNameReaderUpdateReaderInLibraian() {
		return jTextFieldUserNameReaderUpdateReaderInLibraian.getText();
	}

	public String getjTextFieldNameReaderUpdateReaderInLibraian() {
		return jTextFieldNameReaderUpdateReaderInLibraian.getText();
	}

	public int getjTextFieldAgeReaderUpdateReaderInLibraian() {
		return Integer.parseInt(jTextFieldAgeReaderUpdateReaderInLibraian.getText());
	}

	public String getjTextFieldAddresssReaderUpdateReaderInLibraian() {
		return jTextFieldAddresssReaderUpdateReaderInLibraian.getText();
	}

	public long getjTextFieldPhoneNumberReaderUpdateReaderInLibraian() {
		return Long.parseLong(jTextFieldPhoneNumberReaderUpdateReaderInLibraian.getText());
	}

	public long getjTextFieldCMNDReaderUpdateReaderInLibraian() {
		return Long.parseLong(jTextFieldCMNDReaderUpdateReaderInLibraian.getText());
	}

	public int getjTextFieldCodeReaderUpdateReaderInLibrarian() {
		return Integer.parseInt(jTextFieldCodeReaderUpdateReaderInLibrarian.getText());
	}

	public String getjTextFieldBookCodeInLibrarianFoundSuccess() {
		return jTextFieldBookCodeInLibrarianFoundSuccess.getText();
	}
...
//		JFrame jFrame = new JFrame();
	...
	public void userInterFace(String nameUser) {
		...
		jPanel_Button.add(jButton_BorrowReader);
...
//		JFrame jFrame = new JFrame();
		...
		jButton_BorrowReader = new JButton("Người mượn");
		jButton_BorrowReader.addActionListener(ac);
		...
		JPanel jPanel_Button = new JPanel(new GridLayout(3, 1,50,50));
		jPanel_Button.setBorder(BorderFactory.createEmptyBorder(20, 20, 20, 20));
	...
	public void interfaceBorrowReader(String userName) {
		jFrame.setTitle("THU VIEN BORCELLE");
		jFrame.setSize(1000,500);
		jFrame.setLocationRelativeTo(null);
		jFrame.setDefaultCloseOperation(jFrame.EXIT_ON_CLOSE);
		...
		JPanel jPanel_Borrower = new JPanel(new GridLayout(0, 4,10,10));
		JLabel jLabelIdUser = new JLabel("Mã đọc giả");
		JLabel jLabelNameReader = new JLabel("Tên đọc giả");
		JLabel jLabelNameBook = new JLabel("Tên sách");
		JLabel jLabelIdBook = new JLabel("Mã sách");
		jPanel_Borrower.add(jLabelIdUser);
		jPanel_Borrower.add(jLabelNameReader);
		jPanel_Borrower.add(jLabelNameBook);
		jPanel_Borrower.add(jLabelIdBook);
		
		for(ReaderBorrow readerBorrow : Main.dataReaderBorrowed) {
			JLabel jLabelIdUserH = new JLabel(readerBorrow.getIdUser()+"");
			JLabel jLabelNameReaderH = new JLabel(readerBorrow.getNameReader());
			JLabel jLabelNameBookH = new JLabel(readerBorrow.getNameBook());
			JLabel jLabelIdBookH = new JLabel(readerBorrow.getCodeBook()+"");
			jPanel_Borrower.add(jLabelIdUserH);
			jPanel_Borrower.add(jLabelNameReaderH);
			jPanel_Borrower.add(jLabelNameBookH);
			jPanel_Borrower.add(jLabelIdBookH);
		}
		rightPanel.add(jPanel_Borrower, BorderLayout.CENTER);
...
//		jPanelBorderAddReader.add(new JLabel("     "), BorderLayout.SOUTH);
	...
	public void foundUpdateReaderInLibrarian(String userName) {
		...
		JLabel jLabelCodeReader = new JLabel("Mã đọc giả : ");
		jTextFieldCodeReaderUpdateReaderInLibrarian = new JTextField();
		
		
		jPanelAddDeader.add(jLabelCodeReader);
		jPanelAddDeader.add(jTextFieldCodeReaderUpdateReaderInLibrarian);
...
//		jPanelBorderAddReader.add(new JLabel("     "), BorderLayout.SOUTH);
	...
	public void updateReaderInLibrarian(String userName) {
		...
		jTextFieldCodeReaderUpdateReaderInLibraian = new JTextField();
		jTextFieldUserNameReaderUpdateReaderInLibraian = new JTextField();
		jTextFieldPassworkReaderUpdateReaderInLibraian = new JTextField();
		jTextFieldNameReaderUpdateReaderInLibraian = new JTextField();
		jTextFieldAgeReaderUpdateReaderInLibraian = new JTextField();
		jTextFieldAddresssReaderUpdateReaderInLibraian = new JTextField();
		jTextFieldPhoneNumberReaderUpdateReaderInLibraian = new JTextField();
		jTextFieldCMNDReaderUpdateReaderInLibraian = new JTextField();
		
		jPanelAddDeader.add(jLabelCodeReader);
		jPanelAddDeader.add(jTextFieldCodeReaderUpdateReaderInLibraian);
		jPanelAddDeader.add(jLabelUserNameReader);
		jPanelAddDeader.add(jTextFieldUserNameReaderUpdateReaderInLibraian);
		jPanelAddDeader.add(jLabelPassworkReader);
		jPanelAddDeader.add(jTextFieldPassworkReaderUpdateReaderInLibraian);
		jPanelAddDeader.add(jLabelNameReader);
		jPanelAddDeader.add(jTextFieldNameReaderUpdateReaderInLibraian);
		jPanelAddDeader.add(jLabelAgeReader);
		jPanelAddDeader.add(jTextFieldAgeReaderUpdateReaderInLibraian);
		jPanelAddDeader.add(jLabelAddressReader);
		jPanelAddDeader.add(jTextFieldAddresssReaderUpdateReaderInLibraian);
		jPanelAddDeader.add(jLabelPhoneNumberReader);
		jPanelAddDeader.add(jTextFieldPhoneNumberReaderUpdateReaderInLibraian);
		jPanelAddDeader.add(jLabelCMNDReader);
		jPanelAddDeader.add(jTextFieldCMNDReaderUpdateReaderInLibraian);
...
//		jPanelBorderAddReader.add(new JLabel("     "), BorderLayout.SOUTH);
	...
	public void interfaceUpdateReaderSuccess(String userName) {
		jFrame.setTitle("THU VIEN BORCELLE");
		jFrame.setSize(1000,500);
		jFrame.setLocationRelativeTo(null);
		jFrame.setDefaultCloseOperation(jFrame.EXIT_ON_CLOSE);
		...
		JPanel jPanelAddBook = new JPanel(new BorderLayout());
			...
			JLabel jLabelAddBookInLibrarian = new JLabel("Cập nhật thành công !");
...
//		jFrame.setVisible(true);
	...
	public void interfaceUpdateReaderError(String userName) {
		jFrame.setTitle("THU VIEN BORCELLE");
		jFrame.setSize(1000,500);
		jFrame.setLocationRelativeTo(null);
		jFrame.setDefaultCloseOperation(jFrame.EXIT_ON_CLOSE);
		...
		JPanel jPanelAddBook = new JPanel(new BorderLayout());
			...
			JLabel jLabelAddBookInLibrarian = new JLabel("Cập nhật không thành công !");
			jLabelAddBookInLibrarian.setFont(new Font("Arial", Font.PLAIN, 30));	
			jLabelAddBookInLibrarian.setHorizontalAlignment(JLabel.CENTER);
			jLabelAddBookInLibrarian.setVerticalAlignment(JLabel.CENTER);
			jPanelAddBook.add(jLabelAddBookInLibrarian, BorderLayout.CENTER);
...
//		jFrame.setVisible(true);
	...
	public void interfaceUpdateBook(String userName) {
		...
		JPanel jPanelAddBook = new JPanel(new GridLayout(6,2,10,40));
			...
			jTextFieldCodeBookNeedUpdateInLibrarian = new JTextField();
		
			
			jPanelAddBook.add(jLabelCodeBook);
			jPanelAddBook.add(jTextFieldCodeBookNeedUpdateInLibrarian);
...
//		jFrame.setVisible(true);
	...
	public void interfaceFoundBookinLibrarian(String userName) {
		...
		JPanel jPanelAddBook = new JPanel(new GridLayout(6,2,10,40));
			...
			jTextFieldBookCodeInLibrarianFoundSuccess = new JTextField();
		
			
			jPanelAddBook.add(jLabelCodeBook);
			jPanelAddBook.add(jTextFieldBookCodeInLibrarianFoundSuccess);
...
//		jFrame.setVisible(true);
	...
	public void interfaceFoundBookInLibrarianSuccess(String userName, ArrayList<Books> bookFound) {
		jFrame.setTitle("THU VIEN BORCELLE");
		jFrame.setSize(1000,500);
		jFrame.setLocationRelativeTo(null);
		jFrame.setDefaultCloseOperation(jFrame.EXIT_ON_CLOSE);
		...
		JPanel jPanelAddBook = new JPanel(new GridLayout(0,6,10,10));
			...
			for(Books book : bookFound) {
				JLabel jLabelCodeBookL = new JLabel(book.getBookCode()+"");
				JLabel jLabelNameBookL = new JLabel(book.getBookName());
				JLabel jLabelAuthorBookL = new JLabel(book.getAuthorName());
				JLabel jLabelYearBookL = new JLabel(book.getPublishYear()+"");
				JLabel jLabelCategoryL = new JLabel(book.getCateGory());
				JLabel jLabelAmountL = new JLabel(book.getAmount()+"");
				jPanelAddBook.add(jLabelCodeBookL);
				jPanelAddBook.add(jLabelNameBookL);
				jPanelAddBook.add(jLabelAuthorBookL);
				jPanelAddBook.add(jLabelYearBookL);
				jPanelAddBook.add(jLabelCategoryL);
				jPanelAddBook.add(jLabelAmountL);
			}
