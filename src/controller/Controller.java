...
//	public JFrame jFrameAll;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(getStringAction.equals("Tìm kiếm đọc giả cần cập nhật")) {
			view.getJFrame().setVisible(false);
		    view.getJFrame().getContentPane().removeAll();
		    librarian.foundReaderNeedUpdate(view.getjTextFieldCodeReaderUpdateReaderInLibrarian(), view, nameUser);
		    view.getJFrame().revalidate();
		    view.getJFrame().repaint();
		    view.getJFrame().setVisible(true);
		}
		if(getStringAction.equals("Xác nhận cập nhật đọc giả")) {
			view.getJFrame().setVisible(false);
		    view.getJFrame().getContentPane().removeAll();
		    reader.updateDataReaderImformation(view.getjTextFieldCodeReaderUpdateReaderInLibrarian(), view,nameUser
		    		,view.getjTextFieldCodeReaderUpdateReaderInLibraian(),view.getjTextFieldUserNameReaderUpdateReaderInLibraian(), view.getjTextFieldPassworkReaderUpdateReaderInLibraian(), view.getjTextFieldNameReaderUpdateReaderInLibraian()
		    		,view.getjTextFieldAgeReaderUpdateReaderInLibraian(), 
		    		view.getjTextFieldAddresssReaderUpdateReaderInLibraian(), view.getjTextFieldPhoneNumberReaderUpdateReaderInLibraian(), view.getjTextFieldCMNDReaderUpdateReaderInLibraian());
		    view.getJFrame().revalidate();
		    view.getJFrame().repaint();
		    view.getJFrame().setVisible(true);
		}
		...
		if(getStringAction.equals("Xác nhận tìm sách")) {
			view.getJFrame().setVisible(false);
		    view.getJFrame().getContentPane().removeAll();
		    view.interfaceFoundBookInLibrarianSuccess(nameUser, book.foundBook(view.getjTextFieldBookCodeInLibrarianFoundSuccess()));
		    view.getJFrame().revalidate();
		    view.getJFrame().repaint();
		    view.getJFrame().setVisible(true);
		}
		...
		if(getStringAction.equals("Người mượn")) {
			view.getJFrame().setVisible(false);
		    view.getJFrame().getContentPane().removeAll();
		    view.interfaceBorrowReader(nameUser);
		    view.getJFrame().revalidate();
		    view.getJFrame().repaint();
		    view.getJFrame().setVisible(true);
		}
